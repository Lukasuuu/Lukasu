      ...
      <Card className="w-full max-w-lg mx-4 shadow-lg border-border bg-card/80 backdrop-blur-sm">
        <CardContent className="pt-8 pb-8 text-center">
          ...
          <p className="text-foreground/70 mb-8 leading-relaxed">
            Desculpe, a página que procura não existe.
            <br />
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button
              ...
              className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2.5 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg"
            >
